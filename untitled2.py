# -*- coding: utf-8 -*-
"""
Created on Sat Sep  7 13:51:31 2019
...
# --- Read Data --- #
data = pd.read_csv('F:\\19-20 Teaching\\HPDM\\Recomendation Engine\\lastfm-matrix-germany.csv')
...
for i in range(0,len(data_ibs.columns)):
    data_neighbours.iloc[i,:10] = data_ibs.iloc[0:,i].sort_values(ascending=False)[:10].index[:10]
